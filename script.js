...
document.getElementById("plusbttn").addEventListener("click", btnIncreasedValue);
...
document.getElementById("minusbttn").addEventListener("click", btnDecreasedValue);
 

function isAnyCheckboxChecked() {
    // Get the checkbox states
    const includeUppercase = document.getElementById("includeCapsLetters").checked;
    const includeLowercase = document.getElementById("includeSmallLetters").checked;
